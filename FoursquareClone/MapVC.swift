...
class MapVC: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        locationManager.desiredAccuracy = kCLLocationAccuracyBest // bize har,tada en iyi sonucu ver
        locationManager.requestWhenInUseAuthorization() // sadece kullandığım zaman göstermesi yeterli
    ...
    @objc func chooseLocation(gestureRecognizer: UIGestureRecognizer){
        if gestureRecognizer.state == UIGestureRecognizer.State.began { // gerçekten biri buraya tıkladı ve başlattıysa
